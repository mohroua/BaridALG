...
addQuestion("أي من السنوات التالية يُصنّف كتاريخ رسمي لإنشاء مؤسسة بريد الجزائر؟", ["1962", "1975", "1990", "2000"], 0);
addQuestion("كم هو الحد الأقصى المسموح به للسحب من جهاز الصراف الآلي في الجزائر في عملية واحدة؟", ["10,000 دج", "20,000 دج", "50,000 دج", "100,000 دج"], 2);
